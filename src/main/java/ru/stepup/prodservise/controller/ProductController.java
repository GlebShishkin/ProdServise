...
public class ProductController {
    ...
    public ProductDto getProductById(@RequestParam Long id) throws SQLException {
         Product product = productService.getProduct(id).orElseThrow(() -> new NotFoundException("Продукт с id = " + id + " не найден", 400));
...
//        log.info("1) ###/api:  doPay payDto.getProdId = " + payDto.prodId() + "; payDto.getSaldo() = " + payDto.saldo());
